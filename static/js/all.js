(function($){
    ...
    function init_shortcodes(){
        ...
        $(".tpl-minimal-tabs > li a").click(function(event){
            ...
            $(".tpl-minimal-tabs").find("li.active").removeClass("active")
